...
public class QuizNormalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextTv = findViewById(R.id.textNormal);
        mVoiceBtn = findViewById(R.id.voiceBtnNormal);
        btnPass1 = findViewById(R.id.btnPassNormal);
        tvQ = findViewById(R.id.tvQN);
        ...
        btnPass1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(curNum == questionCount -1){
                    ...
                    Intent intent = new Intent (QuizNormalActivity.this, ResultNormalActivity.class);
    ...
    public void countDownTimer(){
        Glide.with(QuizNormalActivity.this).load(R.drawable.wavewhite).into(iv);
        countDownTimer = new CountDownTimer(TOTAL, COUNT_DOWN_INTERVAL) {
            @Override
            public void onTick(long millisUntilFinished) {
                Glide.with(QuizNormalActivity.this).load(R.drawable.countdownwhite).into(iv);
    ...
    public void delayMusicPlay() {
        ...
        handler.postDelayed(new Runnable(){
            ...
            public void run() {
                Glide.with(QuizNormalActivity.this).load(R.drawable.wavewhite).into(iv);
                player = MediaPlayer.create(QuizNormalActivity.this, music[count][songNums[curNum]]);
                mTextTv.setText("");
                player.start();
                player.setLooping(true);
            }
